"""Protocol (structural typing) contracts for all repositories.

Tools depend on these protocols, not the concrete Motor implementations.
This enables mongomock-motor substitution in tests without monkey-patching
and satisfies the Dependency Inversion Principle.
"""
...
class IResearchRepository(Protocol):
    ...
    async def find_interdisciplinary_papers(self, fields: list[str], limit: int = 10) -> list[dict[str, Any]]: ...
