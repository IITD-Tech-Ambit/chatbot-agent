...
class ITaxonomyRepository(Protocol):
    ...
    async def papers_in_context(self, theme_id: Any = None, domain_id: Any = None, department_ref: Any = None, kerberos: str | None = None, limit: int = 10) -> tuple[list[dict[str, Any]], int]: ...
